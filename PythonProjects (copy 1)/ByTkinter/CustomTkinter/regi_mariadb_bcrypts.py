...
def getName():
        if (nameEntry.get() != "") and (usernameEntry.get()!= "") and (passwordEntry.get()!="") and (confirmpasswordEntry.get()!="") and (emailEntry.get()!=""):
            name = nameEntry.get()
            username = usernameEntry.get()
            password = passwordEntry.get()
            confirm = confirmpasswordEntry.get()
            ...
            if password == confirm :
                ...
                mariadb_bcrypts1.mariacrypt(name,username,password,email)
                window.withdraw()
                os.system("python login.py")
                print(name,username,password,confirm,email)
            else:
